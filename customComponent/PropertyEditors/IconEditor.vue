  ...
  <div>
    ...
    <el-dialog :visible.sync="dlgVisible">
      <div>
        ...
        <div style="height: 500px;overflow: auto; display:flex;flex-direction: row;flex-wrap: wrap;">
          <div v-for="cat in icons">
            <i class="fa-2x fa-fw" :class="getIconClass(cat)" @click="onSelect(cat)"
              style="padding: 3px"></i>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getIconClass(name) {
      return this.solid ? 'fa ' + name : 'far ' + name
    },

    isActived(name) {
      return this.buttonTitle == name
    },
    onDone() {
